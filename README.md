...
Hi. I’m Jada Brunson, a fifth-year Computer Engineering student at Georgia Tech, focused on building systems that are efficient, reliable, and grounded in real-world application. I've been born and raised in Georgia my whole life and would like to work in the state upon graduation as well. Some of my hobbies outside of school in-clude dancing and playing with my cat Misty. My academic and professional experience spans embedded systems, software engineering, data processing, and machine learning. I’m particularly interested in how hardware and software come together to create systems that interact with the world—whether that’s through robotics, distributed services, mobile platforms, or intelligent automation.
...
One of the most defining experiences of my time at Georgia Tech has been my undergraduate research on space-based solar power systems. As part of a multidisciplinary team, I investigated the feasibility and efficiency of transmitting solar energy from space to Earth using radio frequency (RF) beamforming. Our work focused on simulating power transmission patterns using MATLAB and HFSS, analyzing the effects of antenna configurations, propagation losses, and interference. Through this research, I gained hands-on experience with RF simulation, signal modeling, and systems engineering in the context of emerging energy technologies. The project culminated in a co-authored IEEE publication, which I had the opportunity to present at an international conference in Portugal. This experience gave me valuable exposure to technical research, collaborative problem solving, and communicating complex results to both technical and non-technical audiences.
